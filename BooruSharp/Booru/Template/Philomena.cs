...
public abstract class Philomena : ABooru {
    ...
    protected override void PreRequest(HttpRequestMessage message) {
        ...
        if (Auth != null) query["key"] = Auth.PasswordHash;
    ...
    private protected override JToken ParseFirstPostSearchResult(object json) {
        ...
        if (token["images"] is JArray arr) return arr.FirstOrDefault() ?? throw new Search.InvalidTags();
    ...
    private Search.Tag.TagType GetTagType(string typeName) {
        ...
        // TODO: https://ponybooru.org/tags
        
        return typeName switch {
        
            "rating" => Search.Tag.TagType.Rating,
            "species" => Search.Tag.TagType.Species,
            "character" => Search.Tag.TagType.Character,
            null => Search.Tag.TagType.Trivia,
            _ => (Search.Tag.TagType)6
        };
    }
}
